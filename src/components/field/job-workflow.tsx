...
export function JobWorkflow({
  ...
  function currentDetailsRow(): JobDetailsRow {
    return {
      ...
      rams_drive_file_id: detailsRow?.rams_drive_file_id ?? null,
      site_plan_storage_path: detailsRow?.site_plan_storage_path ?? null,
      site_plan_drive_file_id: detailsRow?.site_plan_drive_file_id ?? null,
      design_pack_storage_path: detailsRow?.design_pack_storage_path ?? null,
      design_pack_drive_file_id: detailsRow?.design_pack_drive_file_id ?? null,
