...
type WarrantySearchParams = { category_id?: string; status?: string; warranty_status?: string };
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/office/asset-register" className="text-sm whitespace-nowrap underline-offset-2 hover:underline">
      ...
      <form className="flex flex-wrap items-end gap-2" method="get">
        ...
        {hasAnyFilter && (
          <Link href="/office/asset-register/warranty" className="text-muted-foreground text-sm underline">
            Clear
          </Link>
        )}
      </form>
