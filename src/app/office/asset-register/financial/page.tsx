...
type FinancialSearchParams = { category_id?: string; status?: string };
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form className="flex flex-wrap items-end gap-2" method="get">
        ...
        {(categoryId || status) && (
          <Link href="/office/asset-register/financial" className="text-muted-foreground text-sm underline">
            Clear
          </Link>
        )}
      </form>
