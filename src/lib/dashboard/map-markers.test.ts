...
describe("buildJobMapMarkers", () => {
  it("drops jobs whose site has no coordinates on file", () => {
    const markers = buildJobMapMarkers([
      { id: "1", job_number: "UXG-1", status: "scheduled", parent_job_id: null, project_id: null, site: { name: "Site A", latitude: null, longitude: null }, assigned: null },
      { id: "2", job_number: "UXG-2", status: "scheduled", parent_job_id: null, project_id: null, site: null, assigned: null },
      { id: "3", job_number: "UXG-3", status: "scheduled", parent_job_id: null, project_id: null, site: { name: "Site C", latitude: 53.1, longitude: -0.5 }, assigned: null },
    ]);
  ...
  it("drops jobs whose status isn't scheduled or actively being worked", () => {
    ...
    const markers = buildJobMapMarkers([
      { id: "1", job_number: "UXG-1", status: "dispatched", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "2", job_number: "UXG-2", status: "accepted", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "3", job_number: "UXG-3", status: "on_hold", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "4", job_number: "UXG-4", status: "submitted", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "5", job_number: "UXG-5", status: "under_review", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "6", job_number: "UXG-6", status: "approved", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "7", job_number: "UXG-7", status: "closed", parent_job_id: null, project_id: null, site, assigned: null },
      { id: "8", job_number: "UXG-8", status: "cancelled", parent_job_id: null, project_id: null, site, assigned: null },
    ]);
  ...
  it("categorizes a revisit job as 'revisit' rather than its status bucket", () => {
    const site = { name: "Site A", latitude: 53.1, longitude: -0.5 };
    const markers = buildJobMapMarkers([
      { id: "1", job_number: "UXG-1", status: "scheduled", parent_job_id: "parent-1", project_id: null, site, assigned: null },
    ]);
    ...
    const markers = buildJobMapMarkers([
      {
        ...
        status: "in_progress",
        parent_job_id: null, project_id: null,
