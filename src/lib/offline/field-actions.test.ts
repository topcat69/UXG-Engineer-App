...
function jobDetailsRow(overrides: Partial<JobDetailsRow> = {}): JobDetailsRow {
  return {
    ...
    rams_drive_file_id: null,
    site_plan_storage_path: null,
    site_plan_drive_file_id: null,
    design_pack_storage_path: null,
    design_pack_drive_file_id: null,
    ...
    parking_permit_storage_path: null,
    parking_permit_drive_file_id: null,
    site_manager_name: null,
    site_manager_phone: null,
    health_safety_checks_complete: null,
    equipment_located: null,
    working_order_check: null,
    obvious_damage_check: null,
    arrival_notes: null,
